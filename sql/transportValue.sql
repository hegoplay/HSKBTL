use QLDuLich
go
insert into loaiPhuongTien(tenLoai) values 
    (N'Công ty hàng không'),(N'Công ty xe Khách'),(N'Công ty đường sắt'),(N'Công ty đường biển')
insert into LoaiVe(maLoaiVe,tenLoaiVe) values
    (1,N'thương gia'),(2,N'khứ hồi'),(3,N'phổ thông')
go
