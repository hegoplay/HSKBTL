...
public class QuanLyVeController implements ActionListener,ControllerQuanLyVe {
	...
	public VePhuongTien getVeFromField(){
		return new VePhuongTien(
            0, (String)(view.cbTenCongTy.getSelectedItem()), (String)view.cbLoaiVe.getSelectedItem(), model.dsTT.getTTTheoMa(model.dsTT.getMaTinhThanh((String)view.cbTPDiemdi.getSelectedItem())), 
